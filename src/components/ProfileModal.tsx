        ...
        >
          ...
          <div>
            ...
            <div className="mt-1.5 flex items-center justify-between">
              ...
              >
                ...
                <span>{t("profile.uploadCustom")}</span>
              </button>
              <input
                ref={fileInputRef}
                type="file"
          ...
          <div>
            ...
            <input
              ...
              maxLength={24}
              placeholder={t("profile.enterCaptainName")}
          ...
          <div>
            ...
            <div className="text-right text-[9px] text-amber-200/60 mt-0.5">
              {aboutMe.length}/120 {t("profile.characters")}
            </div>
          </div>
