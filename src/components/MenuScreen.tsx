...
export function MenuScreen({
  ...
  return (
    <div className="absolute inset-0 w-full h-full z-50 flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Top Bar / Controls */}
      <div className="absolute top-0 right-0 p-4 sm:p-6 z-20 flex items-center gap-2">
        <LanguageSelector />
        <button
          onClick={toggleMute}
          className="w-10 h-10 sm:w-12 sm:h-12 bg-[#4a2c17]/80 backdrop-blur-sm border-2 border-[#d97706] rounded-full flex items-center justify-center text-white shadow-lg active:scale-95 transition-transform"
        >
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 z-10 relative">
              ...
              <div className="flex flex-col items-center text-center">
                <span className="font-black text-white text-lg sm:text-2xl tracking-widest drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)] uppercase">
                  {t("nav.startVoyage")}
                </span>
