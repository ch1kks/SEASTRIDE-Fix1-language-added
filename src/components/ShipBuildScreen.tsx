        ...
        <div className="w-[85px] sm:w-[100px] flex flex-col justify-center pl-2 sm:pl-3 z-20 shrink-0 py-4 h-full">
          <div className="tutorial-hub flex flex-col gap-2.5 sm:gap-4 w-full p-1 -m-1 rounded-2xl">
            ...
            >
              ...
              <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-wider text-indigo-50">
                {t("shipyard.shop")}
              </span>
            </button>
            ...
            >
              ...
              <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-wider text-sky-50">
                {t("shipyard.upgrades")}
              </span>
            </button>
